"""
对于每个术语i而言
1.首先统计经过层层挑战的术语在2018-2020和2013-2015年出现的次数n_18_20,n_13_15，统计统计一下2018-2020和2013-2015年术语记录总数N_18_20,N_13_15
2.计算2019-2020出现次数n_19_20和N_19_20。2017-2018出现次数n_17_18和N_17_18
之后计算方法参照公式吧，不好直接写出来的
"""
"""
...
# 这个是不统一大小写的情况，在光伏电池的数据集里不统一效果反而更好
...
# 这个是统一成小写后，在这个数据集里，不统一大小写效果反而更好
# data_2011 = json.loads(linecache.getline("../Keyphrase/data/new_2011_2020.json", 1))
# data_2012 = json.loads(linecache.getline("../Keyphrase/data/new_2011_2020.json", 2))
# data_2013 = json.loads(linecache.getline("../Keyphrase/data/new_2011_2020.json", 3))
# data_2014 = json.loads(linecache.getline("../Keyphrase/data/new_2011_2020.json", 4))
# data_2015 = json.loads(linecache.getline("../Keyphrase/data/new_2011_2020.json", 5))
# data_2016 = json.loads(linecache.getline("../Keyphrase/data/new_2011_2020.json", 6))
# data_2017 = json.loads(linecache.getline("../Keyphrase/data/new_2011_2020.json", 7))
# data_2018 = json.loads(linecache.getline("../Keyphrase/data/new_2011_2020.json", 8))
# data_2019 = json.loads(linecache.getline("../Keyphrase/data/new_2011_2020.json", 9))
# data_2020 = json.loads(linecache.getline("../Keyphrase/data/new_2011_2020.json", 10))
...
Escore_1 = {key: value for key, value in Escore.items() if value >= -10000}
